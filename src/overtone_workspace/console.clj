(ns overtone-workspace.console
  (:use [overtone.live]
        [overtone-workspace.fn sequencer util ambi-rand prob-beats beats markov-logistics]
        [overtone-workspace.synth fmchord grumbles laserbeam latchbell]))
